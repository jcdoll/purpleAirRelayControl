...
class PurpleAirClient:
    ...
    def _is_api_key_configured(self):
        ...
        return (self.api_key and 
                ...
                len(self.api_key) > 10)  # API keys are longer than 10 chars
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if 'pm2_5_atm' in data:
                        ...
                        if pm25_for_calc >= 0:
                            print(f"    Using 'pm2_5_atm' from local sensor for AQI calculation.")
    ...
    def get_multiple_sensors_api(self, sensor_ids):
        ...
        try:
            ...
            sensor_list = '%2C'.join(str(id) for id in sensor_ids)  # URL-encoded comma like Arduino
